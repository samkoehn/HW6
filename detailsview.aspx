...
<body>
    ...
    <div>
        ...
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="rpID" DataSourceID="sql_recipe" Height="50px" Width="245px">
            <Fields>
